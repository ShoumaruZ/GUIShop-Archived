...
public class MainShop {
    ...
    private static final Content PUMPKIN = new Content(Item.getBlock(BlockID.PUMPKIN), "カボチャ", "textures/blocks/pumpkin_side", 25, 5);
    private static final Content MELON = new Content(Item.getBlock(BlockID.MELON_BLOCK), "スイカ", "textures/blocks/melon_side", 25, 5);
